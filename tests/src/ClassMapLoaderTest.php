...
class ClassMapLoaderTest extends \PHPUnit_Framework_TestCase
{
     ...
     * @var \Ophp\Loader\ClassMapLoader
     */
    ...
    public function setUp()
    {
        ...
        $this->pLoader = new \Ophp\Loader\ClassMapLoader();
    }
    ...
    /**
     * @covers \Ophp\Loader\ClassMapLoader
     * @group specification
    ...
    {
        $map  = [
            'Ophp\Loader\Exception\UnderflowException' => APPLICATION_PATH . \DIRECTORY_SEPARATOR . 'src'
    ...
    public function testAllowsRegisteringArrayAutoloadMapViaConstructor()
    {
        $map    = array(
            ...
            . DIRECTORY_SEPARATOR . 'Exception'
            . DIRECTORY_SEPARATOR . 'UnderflowException.php' );
        $loader = new \Ophp\Loader\ClassMapLoader( [ $map ] );
    ...
    public function testRegisteringMultipleMapsMergesThem()
    {
        ...
        $map = array(
            'Ophp\Loader\Exception\OutOfBoundsException' => $exceptionPath . \DIRECTORY_SEPARATOR . 'OutOfBoundsException.php',
            'Ophp\Loader\Exception\UnderflowException'   => $exceptionPath . \DIRECTORY_SEPARATOR . 'bogus.php' );
        ...
        $this->assertNotEquals( $map['Ophp\Loader\Exception\UnderflowException'], $test['Ophp\Loader\Exception\UnderflowException'] );
    }
    ...
    public function testAutoloadLoadsClasses()
    {
        ...
        $map    = array( 'OphpTest\Loader\provider\ClassMappedClass' => $file );
        $this->pLoader->setOptions( [ $map ] );
        $loaded = $this->pLoader->autoload( 'OphpTest\Loader\provider\ClassMappedClass' );
        $this->assertSame( 'OphpTest\Loader\provider\ClassMappedClass', $loaded );
        $this->assertTrue( class_exists( 'OphpTest\Loader\provider\ClassMappedClass', false ) );
    }
    ...
    public function testIgnoresClassesNotInItsMap()
    {
        ...
        $map  = array( 'OphpTest\Loader\provider\ClassMappedClass' => $file );
        $this->pLoader->setOptions( [ $map ] );
        $this->assertFalse( $this->pLoader->autoload( 'OphpTest\Loader\provider\UnMappedClass' ) );
        $this->assertFalse( class_exists( 'OphpTest\Loader\provider\UnMappedClass', false ) );
    }
